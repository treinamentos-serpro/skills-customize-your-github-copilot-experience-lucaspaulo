...
- Criar uma estrutura para armazenar as letras já adivinhadas.
...
- Solicitar ao jogador um palpite de letra em cada rodada.
...
- Encerrar a partida quando todas as letras forem descobertas ou quando as tentativas incorretas terminarem.
